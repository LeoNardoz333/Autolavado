...
if(isset($_POST['ide']))
{
    ...
    Nombre <input type="text" name="txtNombre" placeholder="Nombre Cliente" class="form-control" value=
    "'.$dc[2].'"> 
    Auto <input type="text" name="txtAuto" placeholder="Auto" class="form-control" value=
    "'.$dc[3].'">
...
?>
    ...
    Cantidad <input type="text" name="txtCaracteristica" placeholder="Caracteristica" class="form-control" value=".
    '.$dc[6].'">
